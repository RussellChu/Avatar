package com.pj.common
{
	...
	public class AssetLoader implements IDisposable
	{
		...
		private var _currCreate:BasicObject = null;
		...
		public function addCreate(p_key:String, p_create:BasicObject):Boolean
		{
			if (this._registerMap[p_key])
			{
				return false;
		...
		public function getCreate(p_key:String):BasicObject {
			return this._assetMap[p_key] as BasicObject;
		}
